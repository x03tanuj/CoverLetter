    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1.5rem', backgroundColor: 'var(--bg-main)' }}>
      <div style={{ width: '100%', maxWidth: '440px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
          ...
          <h1 style={{ fontSize: '2rem', margin: '0.25rem 0' }}>Welcome Back</h1>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>
            Sign in to continue generating tailored cover letters.
          </p>
        </div>

        {/* Card Form */}
        <div className="neo-card-lg">
          <h2 style={{ fontSize: '1.4rem', marginBottom: '1.25rem' }}>Sign In</h2>
          ...
          <div style={{ marginTop: '1.5rem', textAlign: 'center', borderTop: '2px dashed #DDD', paddingTop: '1rem', fontSize: '0.875rem' }}>
            ...
            <Link to="/register" style={{ color: 'var(--text-main)', fontWeight: '700', textDecoration: 'underline' }}>
              Create Account
            </Link>
          </div>
        </div>
